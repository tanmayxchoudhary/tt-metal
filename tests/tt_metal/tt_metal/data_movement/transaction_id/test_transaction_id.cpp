...
// Gap 1: noc.is_read_trid_flushed — non-blocking per-trid completion poll
TEST_F(GenericMeshDeviceFixture, TensixNocApiIsReadTridFlushed) {
...
// Gap 2: set_async_read_state<NocOptions::TXN_ID> + async_read_with_state<NocOptions::TXN_ID>
TEST_F(GenericMeshDeviceFixture, TensixNocApiStatefulReadWithTrid) {
