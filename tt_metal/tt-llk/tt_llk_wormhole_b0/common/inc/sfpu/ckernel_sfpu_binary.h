...
sfpi_inline sfpi::vFloat _calculate_sfpu_binary_power_(sfpi::vFloat base, sfpi::vFloat pow)
{
    ...
    auto pow_int     = sfpi::convert<sfpi::vSMag16>(pow, sfpi::RoundMode::NearestEven); // int16 should be plenty, since large powers will approach 0/Inf
    ...
    { // negative base
        ...
        v_if (pow_rounded == pow)
        {
            ...
            auto half_pow_int             = sfpi::convert<sfpi::vSMag16>(half_pow, sfpi::RoundMode::NearestEven);
            auto half_pow_floored         = sfpi::convert<sfpi::vFloat>(half_pow_int, sfpi::RoundMode::NearestEven);
